      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm mt-2">Secure and easy cryptocurrency transactions</p>
          </div>
          <div className="flex space-x-6">
            ...
            <a href="https://yourwebsite.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">
              <Globe size={24} />
            </a>
          </div>
        </div>
